...
# ensure that output directories exists
mkdir -p ${outputdir}
...
#simulation_joblist="${outputdir}/rescheduled_twas_jobs.sh"
#simulation_outfile_list="${outputdir}/rescheduled_twas_outfiles.sh"
#simulation_errfile_list="${outputdir}/rescheduled_twas_errfiles.sh"
...
ngenes=98
ncausal_gene_numbers=(1) ## to test other causal gene models, just add more numbers to this array 
nsamples=1000
plottype="png"
...
sim_jobs="sim.1kg.compile.results,sim.1kg.plot.results,sim.1kg.list.Rdata.files"
